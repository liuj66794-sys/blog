...
export function injectLessonNav(html, back) {
  ...
  const assets = `${theme}<link rel="stylesheet" href="${withBase('/learning/learning-tokens.css')}"><link rel="stylesheet" href="${withBase('/learning/lesson-shell.css')}"><script type="module" src="${withBase('/learning/lesson-shell.mjs')}" data-study-base="${withBase('/')}"${back.examDate ? ` data-exam-date="${escapeHtml(back.examDate)}"` : ''}></script>`
