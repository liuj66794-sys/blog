  ...
  function mountQuiz(container, questions, opts) {
    ...
    function render() {
      ...
      questions.forEach(function (q, qi) {
        ...
        function finishPick() {
          if (locked) return;
          var pickedLetters = Object.keys(picked);
          ...
          else if (recordWrong) wrong.record(q, { from: fromLabel });
        ...
        if (multi && q.answer) {
          ...
          confirmBtn.addEventListener("click", finishPick);
    ...
    function updateScore() {
      ...
      if (lessonId && finalPct !== null && finalPct > old) {
