...
categories:
  - TypeScript Agent
description: 学习者已完成第 2 课：成功用 interface Tool 定义工具形状，实现了 calculator 和 greeter，并通过 Record<string, Tool 注册表 + runTool 调度函数跑出了正确输出。 Evidence 正常运行输出：结果是 30 和 你好, L1U.J 代…
